...
$(document).ready(function(){
    ...
    if(window.cnblogsConfig.articleEndHtml.articleEndTitle!=""){
        var bottom_html = '<br><p style="font-weight:  bold;font-size: 16px;text-align:  center;color: #ddd;text-indent: 0;">'+ window.cnblogsConfig.articleEndHtml.articleEndTitle +'</p>';
    }else{
